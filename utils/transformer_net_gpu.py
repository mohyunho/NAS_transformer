...
class Sensors_EncoderLayer(torch.nn.Module):
    def __init__(self, dim_m, dim_val, dim_attn, n_heads, fc1_s, dropout=0.2):
...
class Time_step_EncoderLayer(torch.nn.Module):
    def __init__(self, dim_m, dim_val, dim_attn, n_heads, fc1_t, dropout=0.2):
...
class DecoderLayer(torch.nn.Module):
    def __init__(self, dim_m, dim_val, dim_attn, n_heads, fc1_d, dropout=0.2):
